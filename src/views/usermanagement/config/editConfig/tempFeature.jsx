...
export default function TempFeature({
  dtConfig,
  setFieldValue,
  handleChange,
  values,
  ...
  function formatLifespan(hours, minutes) {
    return `${hours} hours ${minutes} minutes`;
  }
  useEffect(() => {
    setFieldValue("lifespan", timeSpan);
  }, [timeSpan, setFieldValue]);
  ...
  return (
    <Box
      ...
      <Typography>Lifespan: {formatLifespan(hours, minutes)}</Typography>
    </Box>
  );
}
