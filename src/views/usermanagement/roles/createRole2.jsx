...
const CreateRoles = ({ isOpen, onClose }) => {
  ...
  const handleTransactionChange = (name, value) => (event) => {
    ...
    if (isChecked && value.pks && value.t30 && value.labanan) {
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Checkbox
                        ...
                        onChange={(event) =>
                          handleSelectAllChange(event, values)
                        }
                      />
                    }
                    label={
                                          ...
                                          <FormLabel
                                            ...
                                            <Checkbox
                                              ...
                                              onChange={(event) => {
                                                ...
                                                if (checked) {
                                                  setFieldValue(
                                                    `permissions[${permissionIndex}].grants[${actionIndex}].action`,
                                      ...
                                      <SelectBox
                                        ...
                                        onChange={(event) => {
                                          event.forEach((option, index) =>
                                            setFieldValue(
                                              `permissions[${permissionIndex}].grants[${actionIndex}].attributes[${index}].attr`,
                                              option.value
                                            )
                                          );
                                        }}
